...
<head>
    ...
    <link rel='icon' href='http://120.26.243.208:8002/yinxiong/images/tuti.ico' type='image/x-ico' />
    <!--bootstrap core css-->
    ...
    <link type="text/css" href="yinxiong/css/report.css" rel="stylesheet"/>
</head>
            ...
            <form action="" method="post">
                <div class="history-form-group is_visible">
                    <div class="history-data-group">
                        ...
                        <ul class="list-inline" id="history-total">
                            ...
                            <li role="separator" class="divider"> | </li>
                            <li><p>平均得分：<img class="stars" src="http://120.26.243.208:8002/yinxiong/images/4stars_greybg.png"></p></li>
                        </ul>
                    </div>
                    <table border="1" class="table table-bordered" id="history-table"><tr>
                        ...
                        <td>七级：A大调音阶</td>
                        <td>2min 13s</td>
                        <td><img class="stars" src="http://120.26.243.208:8002/yinxiong/images/4stars.png"></td>
                        <td>1</td>
                        <td>1</td>
                        <td><button type="button" name="play"><img src="http://120.26.243.208:8002/yinxiong/images/play.png"></button></td></tr>

                        <tr>
                        <td>07:02</td>
                        <td>七级：A大调音阶</td>
                        <td>2min 13s</td>
                        <td><img class="stars" src="http://120.26.243.208:8002/yinxiong/images/5stars.png"></td>
                        <td>0</td>
                        <td>0</td>
                        <td><button type="button" name="play"><img src="http://120.26.243.208:8002/yinxiong/images/play.png"></button></td></tr>
                        ...
                        <td>七级：A大调音阶</td>
                        <td>2min 13s</td>
                        <td><img class="stars" src="http://120.26.243.208:8002/yinxiong/images/2stars.png"></td>
                        <td>9</td>
                        <td>18</td>
                        <td><button type="button" name="play"><img src="http://120.26.243.208:8002/yinxiong/images/play.png"></button></td></tr>
                        ...
                        <td>七级：A大调音阶</td>
                        <td>2min 13s</td>
                        <td><img class="stars" src="http://120.26.243.208:8002/yinxiong/images/3stars.png"></td>
                        <td>6</td>
                        <td>13</td>
                        <td><button type="button" name="play"><img src="http://120.26.243.208:8002/yinxiong/images/play.png"></button></td></tr>
                ...
                <div class="stats-form-group is_invisible">
                        ...
                        <li style="float: left;">
                            ...
                            <img src="http://120.26.243.208:8002/yinxiong/images/timelength.png">
                        </li>
                        ...
                        <img src="http://120.26.243.208:8002/yinxiong/images/score.png">
                        </li>
                        </ul>
                        <div class="hard">
